...
local I = A:T("Tráº¡ng thÃ¡i","rbxassetid://10734984606")
local Mn = A:T("Chung","rbxassetid://10723407389")
local St = A:T("CÃ i Äáº·t","rbxassetid://10734950309")
local M = A:T("Váº­t Pháº©m","rbxassetid://10734975692")
local V4 = A:T("Tá»c - Äáº£o BÃ­ áº¨n","rbxassetid://10747372167")
local E = A:T("Sá»± Kiá»n Biá»n","rbxassetid://10709761530")
local P = A:T("NgÆ°á»i ChÆ¡i","rbxassetid://10747373176")
local V = A:T("Thá» GiÃ¡c","rbxassetid://10723346959")
local R = A:T("Táº­p KÃ­ch","rbxassetid://10723345749")
local T = A:T("Di Chuyá»n","rbxassetid://10723434557")
local S = A:T("Cá»­a HÃ ng","rbxassetid://10734952479")
local D = A:T("TrÃ¡i Ãc Quá»·","rbxassetid://10709761889")
local Mc = A:T("MÃ¡y Chá»§","rbxassetid://10709782582")
--------------------------------------------------------------------------------------------------------
I:Seperator("Discord")

I:Label("Má»i NgÆ°á»i Äá»u Tham Gia Giao LÆ°u")
I:Button("Copy Discord Link",function()
setclipboard("https://discord.gg/c5EYjcvC") 
end)

I:Seperator("Thá»i Gian")

Time = I:Label("Thá»i Gian Thá»±c Hiá»n")
...
Time:Set("[Sever Time]: Giá»: "..Hour.." PhÃºt: "..Minute.." GiÃ¢y: "..Second)
end
...
UpdateClient1()
    ...
    I:Seperator("Tráº¡ng ThÃ¡i NgÆ°á»i ChÆ¡i")

    local localrace = I:Label("Tá»c")
    
    spawn(function()
        while wait() do
            pcall(function()
                localrace:Set("Tá»c:".." "..game:GetService("Players").LocalPlayer.Data.Race.Value)
            end)
        end
    end)
    ...
    local localfrag = I:Label("Äiá»m F")
    
    spawn(function()
        while wait() do
            pcall(function()
                localfrag:Set("Äiá»m F:".." "..game:GetService("Players").LocalPlayer.Data.Fragments.Value)
            end)
        end
    end)
    
    local localbountyhornor = I:Label("Tiá»n ThÆ°á»ng")
    
    spawn(function()
        while wait() do
            pcall(function()
                localbountyhornor:Set("Tiá»n ThÆ°á»ng:".." "..game:GetService("Players").LocalPlayer.leaderstats["Bounty/Honor"].Value)
            end)
        end
    end)
    
    local localDevil = I:Label("TrÃ¡i")
    
    spawn(function()
        while wait() do
            pcall(function()
                if game:GetService("Players").LocalPlayer.Character:FindFirstChild(game:GetService("Players").LocalPlayer.Data.DevilFruit.Value) or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild(game:GetService("Players").LocalPlayer.Data.DevilFruit.Value) then
                    localDevil:Set("TrÃ¡i:".." "..game:GetService("Players").LocalPlayer.Data.DevilFruit.Value)
                else
                    localDevil:Set("KhÃ´ng CÃ³ TrÃ¡i")
                end
            end)
        end
    end)
--------------------------------------------------------------------------------------------------------
Mn:Seperator("Cháº¿ Äá» Farm")

local WeaponList = {"VÃµ","Kiáº¿m","TrÃ¡i","SÃºng"}
_G.SelectWeapon = "VÃµ"
Mn:Dropdown("Chá»n VÅ© KhÃ­",WeaponList,function(V)
_G.SelectWeapon = V
end)
...
task.spawn(function()
	while wait() do
		pcall(function()
			...
			elseif _G.SelectWeapon == "Kiáº¿m" then
				for i ,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
			...
			elseif _G.SelectWeapon == "SÃºng" then
				for i ,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
			...
			elseif _G.SelectWeapon == "TrÃ¡i" then
				for i ,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
...
local AttackList = {"Cháº­m", "BÃ¬nh ThÆ°á»ng", "Nhanh", "Cá»±c Nhanh"}
FireCooldown = "Cá»±c Nhanh"
...
spawn(function()
    while wait() do
        if FireCooldown then
            pcall(function()
                if FireCooldown == "Cháº­m" then
                    FireCooldown = 0.1
                elseif FireCooldown == "BÃ¬nh ThÆ°á»ng" then
                    FireCooldown = 0.07
                elseif FireCooldown == "Nhanh" then
                    FireCooldown = 0.04
                elseif FireCooldown == "Cá»±c Nhanh" then
                    FireCooldown = 0.02
                end
            end)
        end
...
Mn:Seperator("Tá»± Äá»ng CÃ y")

    Mn:Toggle("CÃ y Cáº¥p",_G.Farm,function(V)
        _G.Level = V
        StopTween(_G.Farm)
    end)
...
if World1 then
    Mn:Toggle("CÃ y Nhanh (Cáº¥p 1-300)",_G.FarmFast,function(V)
        _G.Farmfast = V
...
Mn:Toggle("CÃ y Cáº¥p VÃ  Láº¥y Váº­t Pháº©m",false,function(V)
       _G.Level = V
   ...
   Mn:Toggle("CÃ y QuÃ¡i á» Gáº§n",_G.FarmNearest,function(V)
   _G.FarmNearest = V
...
spawn(function()
    ...
    Mn:Seperator("TrÃ¹m BÃ­ áº¨n")
    
    local Et = Mn:Label("Thá»£ sÄn tinh nhuá»")
     
	spawn(function()
		while wait() do
			Et:Set("Thá»£ sÄn tinh nhuá»: "..game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("EliteHunter","Progress"))
		end
	end)
		...
		while wait() do
			pcall(function()
				if game:GetService("ReplicatedStorage"):FindFirstChild("Diablo") or game:GetService("ReplicatedStorage"):FindFirstChild("Deandre") or game:GetService("ReplicatedStorage"):FindFirstChild("Urban") or game:GetService("Workspace").Enemies:FindFirstChild("Diablo") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre") or game:GetService("Workspace").Enemies:FindFirstChild("Urban") then
					Es:Set("Tráº¡ng ThÃ¡i: CÃ³")	
				else
					Es:Set("Tráº¡ng ThÃ¡i: KhÃ´ng")	
				end
			end)
		end
	end)
	
    Mn:Toggle("ÄÃ¡nh TrÃ¹m BÃ­ áº¨n",_G.Elitehunter,function(V)
        _G.Elitehunter = V
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
    ...
    Mn:Toggle("ÄÃ¡nh VÃ  Äá»i MÃ¡y Chá»§",_G.EliteHunterHop,function(V)
        _G.EliteHunterHop = V
    end)
       
Mn:Seperator("RÆ°Æ¡ng")
    
Mn:Toggle("Nháº·t RÆ°Æ¡ng",false,function(V)
 AutoFarmChest = V
...
Mn:Toggle("Dá»«ng Khi CÃ³ Váº­t Pháº©m",function(V)
	_G.StopItemsChest = V
end)
...
Mn:Toggle("Nháº·t RÆ°Æ¡ng Äáº£o KÃ¬ BÃ­",false,function(V)
 _G.ChestMirage = V
...
spawn(function()
    ...
    Mn:Seperator("Cuá»c Äá»t kÃ­ch cá»§a cÆ°á»p biá»n")
    
    Mn:Toggle("ÄÃ¡nh Háº£i Táº·c", _G.Carvender,function(V)
     _G.RaidPirate = V
...
BoneCheck = Mn:Label("XÆ°Æ¡ng Äang CÃ³: N/A")
    
    spawn(function()
        while wait() do
            pcall(function()
                BoneCheck:Set("XÆ°Æ¡ng Äang CÃ³: "..(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Bones","Check")))
            end)
        end
    end)

    Mn:Toggle("CÃ y XÆ°Æ¡ng",_G.Bone,function(V)
        _G.Bone = V
        StopTween(_G.Bone)
    end)
   ...
   local BonePos = CFrame.new(-9506.234375, 172.130615234375, 6117.0771484375)
    ...
    Mn:Toggle("Äá»i XÆ°Æ¡ng",_G.Random_Bone,function(V)
        _G.Random_Bone = V
    end)
    ...
    Mn:Toggle("Tá»± Äá»ng Cáº§u Nguyá»n",pry,function(V)
    _G.Pray = V
    end)
    ...
    Mn:Toggle("Tá»± Äá»ng Thá»­ Váº­n May",Trylux,function(V)
    _G.Trylux = V
    end)
...
spawn(function()
    ...
    local MobKilled = Mn:Label("QuÃ¡i")
    
    spawn(function()
        while wait() do
            pcall(function()
                if string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 88 then
                    MobKilled:Set("CÃ²n: "..string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"),39,41))
                elseif string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 87 then
                    MobKilled:Set("CÃ²n: "..string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"),39,40))
                elseif string.len(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner")) == 86 then
                    MobKilled:Set("CÃ²n: "..string.sub(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner"),39,39))
                else
                    MobKilled:Set("TrÃ¹m Xuáº¥t Hiá»n")
                end
            end)
        end
    end)
    
    Mn:Toggle("CÃ y HoÃ ng Tá»­ BÃ¡nh",_G.DoughtBoss,function(V)
        _G.DoughtBoss = V
    ...
    Mn:Toggle("Tá»± Äá»ng Triá»u Há»i TrÃ¹m",false,function(V)
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CakePrinceSpawner",value)
    end)
    
    Mn:Toggle("Tá»± Äá»ng Vua Bá»t", _G.doughking,function(V)
         _G.doughking = V
        StopTween( _G.doughking)
    end)
    
    Mn:Toggle("Vua Bá»t Äá»i MÃ¡y Chá»§", _G.doughkingHop,function(V)
         _G.doughkingHop = V
    end)
   ...
   Mn:Seperator("ThÃ´ng Tháº¡o")
    
    Mn:Toggle("CÃ y ThÃ´ng Tháº¡o TrÃ¡i",_G.FarmFruitMastery,function(V)
    ...
    Mn:Toggle("CÃ y ThÃ´ng Tháº¡o SÃºng ",_G.FarmGunMastery,function(V)
        _G.FarmGunMastery = V
    ...
    Mn:Seperator("Quan SÃ¡t")
    
    Mn:Toggle("CÃ y Haki Quan SÃ¡t",_G.Observation,function(V)
        _G.Observation = V
    ...
    Mn:Toggle("CÃ y Haki VÃ  Äá»i MÃ¡y Chá»§",_G.Observation_Hop,function(V)
    ...
    local Boss = Mn:Label("Tráº¡ng ThÃ¡i : Chá»n TrÃ¹m")
		...
		while wait() do
			pcall(function()
				if game:GetService("ReplicatedStorage"):FindFirstChild(_G.SelectBoss) or game:GetService("Workspace").Enemies:FindFirstChild(_G.SelectBoss) then
					Boss:Set("Tráº¡ng ThÃ¡i : CÃ³")	
				else
					Boss:Set("Status : KhÃ´ng")	
				end
			end)
		end
	end)
    ...
    Mn:Toggle("ÄÃ¡nh TrÃ¹m",_G.FarmBoss,function(V)
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("AbandonQuest")
        _G.FarmBoss = V
    ...
    Mn:Toggle("ÄÃ¡nh Táº¥t Cáº£ TrÃ¹m",_G.AllBoss,function(V)
        _G.AllBoss = V
        StopTween(_G.AllBoss)
    end)
    
    Mn:Toggle("ÄÃ¡nh Táº¥t Cáº£ VÃ  Äá»i MÃ¡y Chá»§",_G.AllBossHop,function(V)
        _G.AllBossHop = V
    end)
...
--------------------------------------------------------------------------------------------------------
St:Seperator("CÃ y Äáº·t")

St:Toggle("Duy Chuyá»n Dáº¡ng Reset",BypassTP,function(V)
BypassTP = V
end)

St:Seperator("Di Chuyá»n")

local SpeedList = {"100", "150", "250", "300", "325", "350"}
getgenv().TweenSpeed = "350"
St:Dropdown("Tá»c Äá» Bay", SpeedList,function(V)
    getgenv().TweenSpeed = V
end)

    St:Button("Dá»«ng Bay",function()
        topos(game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame)
        _G.Clip = false
    end)
 
St:Toggle("GÃ´m QuÃ¡i",true,function(Mag)
    _G.BringMonster = Mag
    end)
    spawn(function()
        while task.wait() do
...
local Bring = {"Ãt", "Trung BÃ¬nh", "Nhiá»u"}
_G.BringMode = "Ãt"
St:Dropdown("Cháº¿ Äá» GÃ´m QuÃ¡i", Bring,function(V)
    _G.BringMode = V
end)
spawn(function()
    while wait(.1) do
        if _G.BringMode then
            pcall(function()
                if _G.BringMode == "Ãt" then
                    _G.BringMode = 250
                elseif _G.BringMode == "Trung BÃ¬nh" then
                    _G.BringMode = 300
                elseif _G.BringMode == "Nhiá»u" then
                    _G.BringMode = 350
                end
            end)
        end
...
St:Toggle("Tá»± Äá»ng Báº­t Haki",true,function(V)
_G.Haki = V
end)
spawn(function()
    while wait(.1) do
...
St:Toggle("ÄÃ¡nh Nhanh",true,function(r1736_51)
...
St:Toggle("Táº¯t Hiá»u á»¨ng ÄÃ¡nh",true,function(V)
NoAttackAnimation = V
end)

St:Toggle("Táº¯t ThÃ´ng BÃ¡o",false,function(V)
_G.Remove_trct = V
end)
...
St:Toggle("Táº¯t Äáº¿m SÃ¡t ThÆ°Æ¡ng",true,function(Remo)
...
St:Toggle("MÃ n HÃ¬nh Tráº¯ng",_G.WhiteScreen,function(V)
    _G.WhiteScreen = V
...
elseif _G.WhiteScreen == false then
    ...
    St:Toggle("áº¨n QuÃ¡i",_G.hadesinvis,function(V)
    _G.hadesinvis = V
    ...
    St:Seperator("CÃ i Äáº·t CÃ y ThÃ´ng Tháº¡o")
    
    St:Toggle("ChiÃªu Z",true,function(V)
        _G.SkillZ = V
    end)
 
    St:Toggle("ChiÃªu X",true,function(V)
        _G.SkillX = V
    end)
    
    St:Toggle("ChiÃªu C",true,function(V)
        _G.SkillC = V
    end)
    
     St:Toggle("ChiÃªu V",true,function(V)
        _G.SkillV = V
    end)
--------------------------------------------------------------------------------------------------------
if World1 or World2 then
    M:Seperator("Tháº¿ Giá»i")
end

    if World1 then
        M:Toggle("Tá»± Äá»ng Qua Sea 2",_G.SecondSea,function(V)
            _G.SecondSea = V
    ...
    if World2 then
        ...
        M:Toggle("Tá»± Äá»ng Qua Sea 3",_G.ThirdSea,function(V)
            _G.ThirdSea = V
    ...
    if World2 then
        M:Toggle("ÄÃ¡nh NhÃ  MÃ¡y",_G.Factory,function(V)
            _G.Factory = V
    ...
    M:Seperator("Phong CÃ¡ch Chiáº¿n Äáº¥u")
    
    M:Toggle("Tá»± Äá»ng Láº¥y Superhuman",_G.Superhuman,function(V)
        _G.Superhuman = V
    end)
    ...
    M:Toggle("Tá»± Äá»ng Láº¥y DeathStep",_G.DeathStep,function(V)
        _G.DeathStep = V
    end)
    ...
    M:Toggle("Tá»± Äá»ng Láº¥y Sharkman Karate",_G.Sharkman,function(V)
        _G.Sharkman = V
    end)
    ...
    M:Toggle("Tá»± Äá»ng Láº¥y Electric Claw",_G.ElectricClaw,function(V)
        _G.ElectricClaw = V
    ...
    M:Toggle("Tá»± Äá»ng Láº¥y Dragon Talon",_G.DragonTalon,function(V)
        _G.DragonTalon = V
    end)
    ...
    M:Toggle("Tá»± Äá»ng Láº¥y GodHuman",_G.God_Human,function(V)
 _G.God_Human = V
end)
spawn(function()
    while task.wait() do
...
M:Seperator("NguyÃªn Liá»u")

if World2 then
M:Toggle("CÃ y Váº­t Liá»u PhÃ³ng Xáº¡",false,function(V)
Radioactive = V
...
if World2 then  
M:Toggle("CÃ y Giá»t NÆ°á»c Huyá»n BÃ­",false,function(V)
_G.Makori_gay = V
...
if World1 or World2 then
M:Toggle("CÃ y Quáº·ng Dung Nham",_G.Makori_gay,function(V)
_G.Umm = V
StopTween(_G.Umm)
end)
...
if World1 then  
M:Toggle("CÃ y ÄÃ´i CÃ¡nh ThiÃªn Tháº§n",_G.Makori_gay,function(V)
_G.Wing = V
StopTween(_G.Wing)
end)
...
M:Toggle("CÃ y Da",_G.Makori_gay,function(V)
_G.Leather = V
...
if World1 or world2 or World3 then    
M:Toggle("CÃ y Kim Loáº¡i Pháº¿ Liá»u",false,function(V)
Scrap = V
StopTween(Scrap)
end)
...
if World3 then  
M:Toggle("CÃ y Ca Cao",false,function(V)
Cocoafarm = V
StopTween(Cocoafarm)
end)
...
if World3 then     
M:Toggle("CÃ y Váº£y Rá»ng",false,function(V)
Dragon_Scale = V
...
if World3 then    
M:Toggle("CÃ y Thuá»c SÃºng",false,function(V)
Gunpowder = V
StopTween(Gunpowder)
end)
...
if World3 then     
M:Toggle("CÃ y ÄuÃ´i CÃ¡",false,function(V)
Fish = V
StopTween(Fish)
end)
...
if World3 then  
M:Toggle("CÃ y Sá»«ng TÃª GiÃ¡c",false,function(V)
MiniHee = V
StopTween(MiniHee)
end)
...
spawn(function()
    ...
    M:Seperator("Táº­p KÃ­ch NÃ¢ng Cao")
    
    M:Toggle("CÃ y Phoenix Táº­p KÃ­ch",_G.AdvanceDungeon,function(V)
        _G.AdvanceDungeon = V
    ...
    M:Toggle("ÄÃ¡nh CÃ¡ CÆ°a", _G.doughking,function(V)
         _G.saw = V
        StopTween( _G.saw)
    end)
    
    M:Toggle("ÄÃ¡nh CÃ¡ CÆ°a Äá»i MÃ¡y Chá»§", _G.doughkingHop,function(V)
         _G.sawhop = V
    end)
	...
	M:Seperator("Kiáº¿m Waden")
	
	M:Toggle("Láº¥y Kiáº¿m Waden", _G.waden,function(V)
         _G.waden = V
        StopTween( _G.waden)
    end)
    
    M:Toggle("Láº¥y Kiáº¿m Waden Äá»i MÃ¡y Chá»§", _G.wadenhop,function(V)
         _G.wadenhop = V
    end)
    ...
    M:Seperator("RÃ¢u XÃ¡m")
    
    M:Toggle("ÄÃ¡nh RÃ¢u XÃ¡m", _G.doughking,function(V)
         _G.gay = V
        StopTween( _G.gay)
    end)
    
    M:Toggle("ÄÃ¡nh RÃ¢u XÃ¡m Äá»i MÃ¡y Chá»§", _G.doughkingHop,function(V)
         _G.gayhop = V
    end)
    ...
    M:Toggle("Láº¥y Saber",_G.Saber,function(V)
				_G.Saber = V
				StopTween(_G.Saber)
			end)
			
			M:Toggle("Láº¥y Saber Äá»i MÃ¡y Chá»§",_G.SaberHop,function(V)
				_G.SaberHop = V
			end)
 ...
 spawn(function()
    ...
    M:Seperator("Gáº­y LÃ´i")
    
    M:Toggle("Láº¥y Gáº­y LÃ´i v1", _G.doughking,function(V)
         _G.pole = V
        StopTween( _G.pole)
    end)
    
    M:Toggle("Gáº­y LÃ´i v1 Äá»i MÃ¡y Chá»§", _G.doughkingHop,function(V)
         _G.polehop = V
    end)
...
local PolePos = CFrame.new(-7748.0185546875, 5606.80615234375, -2305.898681640625)
    ...
    M:Seperator("Thanh Kiáº¿m Huyá»n Thoáº¡i")

    M:Toggle("Mua Kiáº¿m Huyá»n Thoáº¡i",_G.BuyLegendarySword,function(V)
        _G.BuyLegendarySword = V
    end)
    ...
    M:Toggle("Mua Kiáº¿m Huyá»n Thoáº¡i Äá»i MÃ¡y Chá»§",_G.BuyLegendarySword_Hop,function(V)
        _G.BuyLegendarySword_Hop = V
    end)
    
    M:Seperator("Haki VÅ© Trang MÃ u")
    
    local KuyKoben = game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF_"):InvokeServer("ColorsDealer", "1")
    
    M:Toggle("Mua Haki MÃ u",_G.BuyEnchancementColour,function(V)
        _G.BuyEnchancementColour = V
    end)
    
    M:Toggle("Mua Haki MÃ u Äá»i MÃ¡y Chá»§",_G.BuyEnchancementColour_Hop,function(V)
    ...
    M:Toggle("LÃ m Nhiá»m Vá»¥ Bartlio",_G.Bartilo,function(V)
        _G.Bartilo = V
    end)
    ...
    M:Seperator("KÃ­nh ThiÃªn Nga")
    
    M:Toggle("Láº¥y KÃ­nh ThiÃªn Nga",_G.FarmSwanGlasses,function(V)
    ...
    M:Toggle("Láº¥y KÃ­nh ThiÃªn Nga Äá»i MÃ¡y Chá»§",_G.FarmSwanGlasses_Hop,function(V)
        _G.FarmSwanGlasses_Hop = V
    end)
    
    M:Toggle("Tá»± Äá»ng NÃ¢ng Tá»c V2",_G.EvoRace,function(V)
        _G.EvoRace = V
    ...
    M:Seperator("Váº­t Cháº¥t KÃ¬ Dá»")
    
    M:Toggle("CÃ y Váº­t Cháº¥t KÃ¬ Dá»",_G.Ectoplasm,function(V)
        _G.Ectoplasm = V
    ...
    M:Seperator("Kiáº¿m Rengoku")
    
    M:Toggle("Láº¥y Kiáº¿m Rengoku",_G.Rengoku,function(V)
        _G.Rengoku = V
    ...
    M:Seperator("Kiáº¿m Äinh Ba Rá»ng")
    
	M:Toggle("Láº¥y Äinh Ba Rá»ng", _G.Dragon_Trident,function(V)
         _G.Dragon_Trident = V
        StopTween(_G.Dragon_Trident)
    end)
    
    M:Toggle("Láº¥y Äinh Ba Rá»ng Äá»i MÃ¡y Chá»§", _G.Dragon_Trident_Hop,function(V)
    ...
    M:Toggle("ÄÃ¡nh Rip_Indra True",_G.DarkDagger,function(V)
        _G.DarkDagger = V
    ...
    M:Toggle("ÄÃ¡nh Rip_Indra True Äá»i NÃ¡y Chá»§",_G.DarkDagger_Hop,function(V)
        _G.DarkDagger_Hop = V
    end)
...
M:Toggle("Tá»± Äá»ng Nháº¥n MÃ u Haki",_G.Ob_Color,function(V)
	Open_Color_Haki = V
...
function EquipAllWeapon()
    ...
    M:Seperator("Kiáº¿m Yama")

    M:Toggle("Láº¥y Yama",_G.Yama,function(V)
        _G.Yama = V
        StopTween(_G.Yama)
    end)
    ...
    M:Seperator("LÃ­nh Ngá»± LÃ¢m")
    
    M:Toggle("LÃ m Nhiá»m Vá»¥ Ngá»± LÃ¢m",_G.MusketeerHat,function(V)
        _G.MusketeerHat = V
    ...
    M:Seperator("Kiáº¿m MÃ³c ÄÃ´i")
    
    M:Toggle("Láº¥y MÃ³c ÄÃ´i", _G.TwinHook,function(V)
         _G.TwinHook = V
        StopTween( _G.TwinHook)
    end)
    
    M:Toggle("Láº¥y MÃ³c ÄÃ´i Äá»i MÃ¡y Chá»§", _G.TwinHook_Hop,function(V)
         _G.TwinHook_Hop = V
    end)
    ...
    M:Toggle("Láº¥y Haki 7 MÃ u",_G.Rainbow_Haki,function(V)
        _G.Rainbow_Haki = V
    ...
    M:Toggle("LÃ m Nhiá»m Vá»¥ Haki Quan SÃ¡t V2",_G.Observationv2,function(V)
        _G.Observationv2 = V
    ...
    M:Seperator("Kiáº¿m Carvander")

    M:Toggle("Láº¥y Cavander", _G.Carvender,function(V)
         _G.Carvender = V
        StopTween( _G.Carvender)
    end)
    
    M:Toggle("Láº¥y Carvander Äá»i MÃ¡y Chá»§", _G.Carvenderhop,function(V)
         _G.Carvenderhop = V
    end)
	...
	M:Seperator("Kiáº¿m Tushita")

M:Toggle("Láº¥y Tushita", _G.tushita,function(V)
         _G.tushita = V
        StopTween( _G.tushita)
    end)
    
    M:Toggle("Láº¥y Tushita Äá»i MÃ¡y Chá»§", _G.tushitahop,function(V)
         _G.tushitahop = V
    end)
    ...
    M:Toggle("Tá»± Äá»ng Cáº¥m Äuá»t",_G.HolyTorch,function(V)
        _G.HolyTorch = V
    ...
    M:Seperator("Kiáº¿m LÆ°á»¡i HÃ¡i")
    
    M:Toggle("Láº¥y LÆ°á»¡i HÃ¡i",_G.FarmBossHallow,function(V)
        _G.FarmBossHallow = V
        StopTween(_G.FarmBossHallow)
    end)
    
    M:Toggle("Láº¥y LÆ°á»¡i HÃ¡i Äá»i MÃ¡y Chá»§",_G.FarmBossHallowHop,function(V)
    ...
    M:Seperator("SÃºng Soul Guitar")
    
    M:Toggle("Láº¥y ÄÃ n Ghita Linh Há»n ( Thá»­ )",_G.Guitar,function(V)
  _G.Guitar = V    
 StopTween(_G.Guitar)
 end)
...
M:Toggle("Láº¥y Ghita Linh Há»n Äá»i MÃ¡y Chá»§",false,function(V)
  _G.soulGuitarhop = V    
 end)
    
    M:Seperator("Kiáº¿m Buddy")
    
    M:Toggle("Láº¥y Buddy",_G.BudySword,function(V)
        _G.BudySword = V
        StopTween(_G.BudySword)
    end)
    
    M:Toggle("Láº¥y Buddy Äá»i MÃ¡y Chá»§",_G.BudySwordHop,function(V)
        _G.BudySwordHop = V
    end)
 ...
 M:Seperator("Song Kiáº¿m Nguyá»n Rá»§a")

M:Toggle("Láº¥y! Song Kiáº¿m Nguyá»n Rá»§a ( Thá»­ )",_G.Cdk,function(V)
 _G.CDK = V
StopTween(_G.CDK)
end)
...
--------------------------------------------------------------------------------------------------------
    if World1 or World2 then
V4:Label("HÃ£y Qua Biá»n 3")
end

if World3 then
    V4:Seperator("Äáº£o BÃ­ áº¨n")
	...
	while task.wait() do
		pcall(function()
			if game.Workspace._WorldOrigin.Locations:FindFirstChild("Mirage Island") then
				mr:Set("Äáº£o BÃ­ áº¨n: CÃ³")
			else
				mr:Set("Äáº£o BÃ­ áº¨n: KhÃ´ng")
			end
		end)
	end
end) 

V4:Toggle("Tá»± Äá»ng Äáº£o BÃ­ áº¨n",_G.MysticIsland,function(V)
        _G.MysticIsland = V
    ...
    V4:Toggle("LÃ¡i Thuyá»n",AutoW,function(W)
    AutoW = W
    end)
    spawn(function()
    while wait() do
    ...
    V4:Toggle("Tá»± Äá»ng Triá»u Há»i Äáº£o BÃ­ áº¨n",_G.dao,function(state)
    if state then
        _G.dao = true
    else
        _G.dao = false
...
V4:Toggle("Bay Äáº¿n Ãng BÃ¡n TrÃ¡i Äáº£o BÃ­ áº¨n",_G.TPNPC,function(V)
             _G.Miragenpc = V
...
V4:Button("Bay Äáº¿n Ãng BÃ¡n TrÃ¡i Äáº£o BÃ­ áº¨n", function()
                TweenNpc()
                end)
...
V4:Toggle("NhÃ¬n TrÄng",_G.LockCamToMoon,function(V)
    _G.LockCamToMoon = V
end)
...
V4:Toggle("Bay Äáº¿n BÃ¡nh RÄng",_G.TweenMGear,function(V)
_G.TweenMGear = V
...
if World3 then
    V4:Seperator("Tá»c V4")
    
V4:Button("Bay ÄÃªn Äá»nh CÃ¢y Äáº¡i Thá»¥",function()
  topos(CFrame.new(2947.556884765625, 2281.630615234375, -7213.54931640625))
end)
    
V4:Button("VÃ o NgÃ´i Äá»n Thá»i Gian",function()
  Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286, 14897, 103)
end)
    
V4:Button("Bay Äáº¿n Cáº§n Gáº¡t",function()
  topos(CFrame.new(28575.181640625, 14936.6279296875, 72.31636810302734))
end)

V4:Button("Bay Äáº¿n Chá» BÃ¡n BÃ¡nh RÄng",function()
  topos(CFrame.new(28981.552734375, 14888.4267578125, -120.245849609375))
end)

V4:Button("Truy Cáº­p Äá»ng Há»", function()
    game:GetService("Workspace").Map["Temple of Time"].DoNotEnter:Remove()
    game:GetService("Workspace").Map["Temple of Time"].ClockRoomExit:Remove()
end)

V4:Toggle("Mua BÃ¡nh RÄng",_G.Bone4,function(V)
 _G.Bone4 = V
 StopTween(_G.Bone4)
end)
spawn(function()
...
game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF_"):InvokeServer(unpack(args))
  ...
  V4:Button("Bay Äáº¿n Tá»c Báº£n ThÃ¢n",function()
    Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286, 14897, 103)
    wait(.1)
    Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286, 14897, 103)
    wait(.1)
...
V4:Button("Bay Äáº¿n Äá»ng Há»",function()
	topos(CFrame.new(29551.9941, 15069.002, -85.5179291))
end)

  V4:Toggle("Tá»± Äá»ng Qua áº¢i",false,function(v)
  _G.QuestRace = v
...
V4:Toggle("CÃ y & Báº­c Tá»c",false,function(V)
    _G.Bone = V
    _G.Bone4 = V
    _G.ActiveV4 = V
    StopTween(_G.Bone)
...
V4:Toggle("Giáº¿t NgÆ°á»i ChÆ¡i áº¢i",false,function(V)
...
spawn(function()
  ...
  V4:Button("Mua BÃ¡nh RÄng",function(t)
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer('UpgradeRace','Buy')
  end)
end
--------------------------------------------------------------------------------------------------------
    E:Button("XoÃ¡ XÆ°Æ¡ng MÃ¹",function()
...
local ListSeaBoat = {
    ...
    E:Dropdown("Chá»n Thuyá»n",ListSeaBoat,function(V)
        _G.SelectedBoat = V
    end)
    ...
    E:Dropdown("Chá»n VÃ¹ng",ListSeaZone,function(V)
        _G.SelectedZone = V
    end)
    ...
    E:Dropdown("Chá»n Tá»c Äá» Cá»§a Thuyá»n",{"180", "200", "250", "300", "325", "350"},function(V)
        getgenv().SpeedBoat = V
    end)
    
    E:Toggle("Báº¯t Äáº§u Sá»± Kiá»n Biá»n",_G.SailBoat,function(V)
        _G.SailBoat = V
    end)
...
spawn(function()
    ...
    E:Toggle("ÄÃ¡nh CÃ¡",FarmShark,function(V)
        FarmShark = V
        StopTween(FarmShark)
    end)
    
    E:Toggle("ÄÃ¡nh Piranha",_G.farmpiranya,function(V)
        _G.farmpiranya = V
        StopTween(_G.farmpiranya)
    end)
    
    E:Toggle("ÄÃ¡nh Fish Crew",_G.Fish_Crew_Member,function(V)
    ...
    E:Toggle("ÄÃ¡nh Thuyá»n Ma",_G.bjirFishBoat,function(V)
        _G.bjirFishBoat = V
    ...
    E:Toggle("ÄÃ¡nh Thuyá»n",_G.KillGhostShip,function(V)
        _G.KillGhostShip = V
    ...
    E:Toggle("ÄÃ¡nh Terror Shark",_G.Terrorshark,function(V)
        _G.Terrorshark = V
        StopTween(_G.Terrorshark)
    end)
    
    E:Toggle("ÄÃ¡nh Sea Beast",_G.SeaBest,function(V)
        _G.SeaBest = V
...
E:Seperator("CÃ i Äáº·t Sá»± Kiá»n Biá»n")
...
local ListBright = {
    ...
    E:Dropdown("Chá»n Äá» SÃ¡ng",ListBright,function(V)
        BrightValue = V
    end)
    
    E:Button("Báº­c Äá» SÃ¡ng ÄÃ£ Chá»n",function()
        game:GetService("Lighting").Brightness = BrightValue
    end)
    
    E:Toggle("TÄng Tá»c Äá» Thuyá»n",_G.IncreaseBoatSpeed,function(V)
    ...
    E:Toggle("XuyÃªn ÄÃ¡",_G.NoClipRock,function(V)
        _G.NoClipRock = V
    end)
            spawn(function()
                while wait() do
    ...
    E:Toggle("Tá»± Äá»ng Nháº¥n W",_G.r71PressW,function(V)
        _G.r71PressW = V
    end)
            spawn(function()
                while wait() do
...
E:Seperator("CÃ i Äáº·t ChiÃªu Sá»± Kiá»n Biá»n")

    E:Toggle("Báº­c ChiÃªu Cá»§a VÃµ",_G.UseSeaMeleeSkill,function(V)
        _G.UseSeaMeleeSkill = V
    end)

    E:Toggle("Báº­c ChiÃªu Cá»§a TrÃ¡i",_G.UseSeaFruitSkill,function(V)
        _G.UseSeaFruitSkill = V
    end)
   
    E:Toggle("Báº­c ChiÃªu Cá»§a Kiáº¿m",_G.UseSeaSwordSkill,function(V)
        _G.UseSeaSwordSkill = V
    end)
    
    E:Toggle("Báº­c ChiÃªu Cá»§a SÃºng",_G.UseSeaGunSkill,function(V)
        _G.UseSeaGunSkill = V
    end)
    
E:Seperator("CÃ i Äáº·t ChiÃªu Cá»§a VÃµ")

    E:Toggle("Sá»­ Dá»¥ng ChiÃªu Z Cá»§a VÃµ",_G.UseSeaFruitSkill,function(V)
        _G.SkillMeleeZ = V
    end)
   
    E:Toggle("Sá»­ Dá»¥ng ChiÃªu X Cá»§a VÃµ",_G.UseSeaSwordSkill,function(V)
        _G.SkillMeleeX = V
    end)
    
    E:Toggle("Sá»­ Dá»¥ng ChiÃªu C Cá»§a VÃµ",_G.UseSeaGunSkill,function(V)
        _G.SkillMeleeC = V
    end)
   
E:Seperator("CÃ i Äáº·t ChiÃªu Cá»§a TrÃ¡i")

    E:Toggle("Sá»­ Dá»¥ng ChiÃªu Z Cá»§a TrÃ¡i",_G.UseSeaFruitSkill,function(V)
        _G.SkillFruitZ = V
    end)
   
    E:Toggle("Sá»­ Dá»¥ng ChiÃªu X Cá»§a TrÃ¡i",_G.UseSeaFruitSkill,function(V)
        _G.SkillFruitX = V
    end)
   
    E:Toggle("Sá»­ Dá»¥ng ChiÃªu C Cá»§a TrÃ¡i",_G.UseSeaFruitSkill,function(V)
        _G.SkillFruitC = V
    end)
   
       E:Toggle("Sá»­ Dá»¥ng ChiÃªu V Cá»§a TrÃ¡i",_G.UseSeaFruitSkill,function(V)
        _G.SkillFruitV = V
    end)
   
       E:Toggle("Sá»­ Dá»¥ng ChiÃªu F Cá»§a TrÃ¡i",_G.UseSeaFruitSkill,function(V)
        _G.SkillFruitF = V
    end)
   
E:Seperator("CÃ i Äáº·t ChiÃªu Cá»§a SÃºng VÃ  Kiáº¿m")

       E:Toggle("Sá»­ Dá»¥ng ChiÃªu Z Cá»§a SÃºng VÃ  Kiáº¿m",_G.UseSeaFruitSkill,function(V)
        _G.SkillGunZ = V
        _G.SkillSwordZ = V
    end)
   
       E:Toggle("Sá»­ Dá»¥ng ChiÃªu X Cá»§a SÃºng VÃ  Kiáº¿m",_G.UseSeaFruitSkill,function(V)
        _G.SkillGunX = V
        _G.SkillSwordX = V
    end)
...
spawn(function()
    ...
    E:Toggle("Tá»± Äá»ng Äáº£o BÄng",_G.FrozenDimension,function(V)
    _G.FrozenDimension = V
    StopTween(_G.FrozenDimension)
    end)
    
    E:Seperator("Sá»± Kiá»n Äáº£o CÃ¡o")
    
    E:Toggle("Tá»± Äá»ng Äáº£o CÃ¡o",_G.FKitsune,function(V)
    _G.FKitsune = V
...
E:Toggle("Bay Äáº¿n Äáº£o CÃ¡o", false, function(V)
    _G.tpkit = V
    StopTween(_G.tpkit)
end)
...
E:Toggle("Nháº·t Ngá»n Lá»­a Xanh", false, function(V)
    _G.CltAze = V
    StopTween(_G.CltAze)
...
E:Button("Äá»i Ngá»n Lá»­a Xanh",function()
game:GetService("ReplicatedStorage"):WaitForChild("Modules"):WaitForChild("Net"):WaitForChild("RF/KitsuneStatuePray"):InvokeServer()
 end)
--------------------------------------------------------------------------------------------------------
V:Seperator("Äá»nh Vá»")

V:Toggle("Äá»nh Vá» NgÆ°á»i ChÆ¡i",false,function(a)
        ESPPlayer = a
	UpdatePlayerChams()
    end)
    
V:Toggle("Äá»nh Vá» Äáº£o CÃ¡o",false,function(V)
        IslandESP = V
...
function UpdateIslandESPKitsune()
    ...
    V:Toggle("Äá»nh Vá» RÆ°Æ¡ng",false,function(a)
        ChestESP = a
	UpdateChestChams() 
    end)
    
    V:Toggle("Äá»nh Vá» TrÃ¡i",false,function(a)
        DevilFruitESP = a
    ...
    V:Toggle("Äá»nh Vá» Hoa Quáº£",RealFruitESP,function(a)
        RealFruitESP = a
	UpdateRealFruitChams() 
    end)
    
    V:Toggle("Äá»nh Vá» Hoa",false,function(a)
        FlowerESP = a
	UpdateFlowerChams() 
    end)
    spawn(function()
...
V:Toggle("Äá»nh Vá» Äáº£o",IslandESP,function(V)
        IslandESP = V
        while IslandESP do wait()
            UpdateIslandESP() 
        end
...
V:Toggle("Äá»nh vá» Äáº£o BÃ­ áº¨n", false, function(V)
    MirageIslandESP = V
...
V:Seperator("TrÃ² ÄÃ¹a")
V:Button('MÆ°a TrÃ¡i', function()
...
V:Button('Cáº¥p Äá»/Beli/EXP Tá»©c Thá»i', function()
local plr = game:GetService("Players").LocalPlayer
	...
	V:Textbox("LÃ m Giáº£ Cáº¥p",true,function(V)
        game:GetService("Players").LocalPlayer.Data.Level.Value = V
    end)
    
    V:Textbox("LÃ m Giáº£ Kinh Nghiá»m",true,function(V)
        game:GetService("Players").LocalPlayer.Data.Exp.Value = V
    end)
    
    V:Textbox("LÃ m Giáº£ Beli",true,function(V)
        game:GetService("Players").LocalPlayer.Data.Beli.Value = V
    end)
    
    V:Textbox("LÃ m Giáº£ Äiá»m TÃ­m",true,function(V)
        game:GetService("Players").LocalPlayer.Data.Fragments.Value = V
    end)
    
    V:Textbox("LÃ m Giáº£ Chá» Sá»",true,function(V)
        game:GetService("Players").LocalPlayer.Data.Points.Value = V
    end)
    
    V:Textbox("LÃ m Giáº£ Tiá»n ThÆ°á»ng",true,function(V)
        game:GetService("Players").LocalPlayer.leaderstats["Bounty/Honor"].Value = V
    end)

V:Seperator("Äiá»m ná»i báº­t")

V:Toggle("áº¨n Khung Chat", _G.chat, function(V)
    _G.chat = V
...
StarterGui:SetCoreGuiEnabled(Enum.CoreGuiType.Chat, true)    
  ...
  V:Toggle("áº¨n Báº£n Tiá»n ThÆ°á»ng", _G.leaderboard, function(a)
    _G.leaderboard = a
...
game:GetService('StarterGui'):SetCoreGuiEnabled(Enum.CoreGuiType.PlayerList, true)   
    ...
    V:Seperator("ÄÃ¡nh cáº¯p")
    V:Button("Má» khÃ³a Buso",function()
...
elseif type(Ability) == 'table' then
   ...
   V:Button("Má» KhoÃ¡ Soru",function()
...
elseif type(Ability) == 'table' then
   ...
   V:Button("Má» KhoÃ¡ Geppo",function()
...
elseif type(Ability) == 'table' then
   for i,v in next , Ability do
    ...
    V:Button("PhÃ³ng To Tá»i Äa", function()
		while wait() do
			game.Players.LocalPlayer.CameraMaxZoomDistance = 9223372036854718
			end
	end)

V:Button("Hiá»n ToÃ n Bá» ThÃ´ng Tin", function(V)
...
V:Seperator("Äá» Hoáº¡")
    
    V:Button("XoÃ¡ SÆ°Æ¡ng MÃ¹ ( Biá»n 3 )",function(qww)
	game:GetService("Lighting").LightingLayers:Destroy()
	game:GetService("Lighting").Sky:Destroy()
end)

V:Toggle("XoÃ¡ SÆ°Æ¡ng MÃ¹",RemoveFog,function(V)
    RemoveFog = V
    ...
    V:Toggle("XoÃ¡ SÃ¡t ThÆ°Æ¡ng",true,function()
    ...
    V:Button("Má» KhoÃ¡ FPS",function()
        setfpscap(9999999)
    end)
    
    V:Button("Giáº£m Äá» Hoáº¡", function()
    ...
    V:Seperator("Kháº£ NÄng")
    
    V:Toggle("KhÃ´ng CÃ³ Thá»i Gian Há»i ChiÃªu",false,function(V)
        nododgecool = V
        NoDodgeCool()
    end)
    
    V:Toggle("VÃ´ Háº¡ng NÄng LÆ°á»£ng",false,function(V)
        InfiniteEnergy = V
        originalstam = LocalPlayer.Character.Energy.Value
    end)
    
    V:Toggle("Kháº£ NÄng VÃ´ Háº¡n",false,function(V)
        InfAbility = V
        if value == false then
            game:GetService("Players").LocalPlayer.Character.HumanoidRootPart:FindFirstChild("Agility"):Destroy()
        end
    ...
    V:Toggle("VÃ´ Háº¡n Haki Quan SÃ¡t",getgenv().InfiniteObRange,function(V)
    ...
    V:Toggle("Geppo VÃ´ Háº¡n",getgenv().InfGeppo,function(V)
        getgenv().InfGeppo = V
    end)
    ...
    V:Toggle("Soru VÃ´ Háº¡n",_G.Infsoru,function(V)
        _G.Infsoru = V
    end)
    ...
    V:Button("XoÃ¡ Dung Nham",function()
		for i,v in pairs(game.Workspace:GetDescendants()) do
			if v.Name == "Lava" then   
				v:Destroy()
			end
...
--------------------------------------------------------------------------------------------------------
    local plyserv = P:Label("NgÆ°á»i ChÆ¡i")
        ...
        while wait() do
            pcall(function()
                for i,v in pairs(game:GetService("Players"):GetPlayers()) do
                    if i == 12 then
                        plyserv:Set("NgÆ°á»i ChÆ¡i:".." "..i.." ".."/".." ".."12".." ".."(Max)")
                    elseif i == 1 then
                        plyserv:Set("NgÆ°á»i ChÆ¡i:".." "..i.." ".."/".." ".."12")
                    else
                        plyserv:Set("NgÆ°á»i ChÆ¡i:".." "..i.." ".."/".." ".."12")
                    end
                end
    ...
    local SelectedPly = P:Dropdown("Chá»n NgÆ°á»i ChÆ¡i",Playerslist,function(V)
        _G.SelectPly = V
    end)
    
    P:Button("LÃ m Má»i",function()
        Playerslist = {}
        SelectedPly:Clear()
        for i,v in pairs(game:GetService("Players"):GetChildren()) do  
    ...
    P:Toggle("Xem NgÆ°á»i ChÆ¡i",false,function(V)
        SpectatePlys = V
    ...
    P:Toggle("Bay Äáº¿n NgÆ°á»i ChÆ¡i",false,function(V)
        _G.TeleportPly = V
        pcall(function()
    ...
    P:Toggle("Bay Dáº¡ng Dá»ch Chuyá»n Äáº¿n NgÆ°á»i ChÆ¡i",false,function(bool)
                                    _G.Teleport = bool
    ...
    P:Seperator("Nhiá»m Vá»¥ NgÆ°á»i ChÆ¡i")
    
    P:Button("Nháº­n Nhiá»m Vá»¥ Giáº¿t NgÆ°á»i ChÆ¡i",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("PlayerHunter")
    end)
    
    P:Toggle("Giáº¿t NgÆ°á»i ChÆ¡i Äang Nháº­m Nhiá»m Vá»¥",_G.PlayerHunter,function(Killzps)
    ...
    P:Toggle("Ghim ChiÃªu",false,function(V)
    _G.AimNearest = V
end)
...
setreadonly(gg, true)
    ...
    P:Toggle("Báº­c PvP",false,function(V)
        _G.EnabledPvP = V
    end)
...
P:Button("Äáº·t Äiá»m Há»i Sinh",function()
	_G.Pos_Spawn = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame
	Com()
end)

    P:Toggle("Cháº¿ Äá» An ToÃ n",false,function(V)
        _G.Safe_Mode = V
    ...
    P:Button("Äáº·t Láº¡i",function()
    ...
    P:Toggle("Báº­c Tá»c V3",_G.ActiveV3,function(V)
        _G.ActiveV3 = V
    end)
    ...
    P:Toggle("Báº­c Tá»c V4",_G.ActiveV4,function(V)
        _G.ActiveV4 = V
    end)
    ...
    P:Toggle("Äi TrÃªn NÆ°á»c",true,function(V)
        _G.WalkWater = V
    end)
    ...
    P:Toggle("XuyÃªn TÆ°á»ng",_G.NoClip,function(V)
        _G.NoClip = V
    end)
...
P:Seperator("Chá» Sá»")
  ...
  local Pointstat = P:Label("Äiá»m Chá» Sá»")
    
    spawn(function()
        while wait() do
            pcall(function()
                Pointstat:Set("Äiá»m Chá» Sá»: "..tostring(game:GetService("Players")["LocalPlayer"].Data.Points.Value))
            end)
        end
    end)
    
local Melee = P:Label("VÃµ: ")
local Defense = P:Label("MÃ¡u: ")
local Sword = P:Label("Kiáº¿m: ")
local Gun = P:Label("SÃºng: ")
local Fruit = P:Label("TrÃ¡i: ")

    spawn(function()
        while wait() do
            pcall(function()
                Melee:Set("VÃµ: "..game.Players.localPlayer.Data.Stats.Melee.Level.Value)
            end)
        end
    end)
    ...
    spawn(function()
        while wait() do
            pcall(function()
                Defense:Set("MÃ¡u: "..game.Players.localPlayer.Data.Stats.Defense.Level.Value)
            end)
        end
    end)
    ...
    spawn(function()
        while wait() do
            pcall(function()
                Sword:Set("Kiáº¿m: "..game.Players.localPlayer.Data.Stats.Sword.Level.Value)
            end)
        end
    end)
    ...
    spawn(function()
        while wait() do
            pcall(function()
                Gun:Set("SÃºng: "..game.Players.localPlayer.Data.Stats.Gun.Level.Value)
            end)
        end
    end)
    ...
    spawn(function()
        while wait() do
            pcall(function()
                Fruit:Set("TrÃ¡i: "..game.Players.localPlayer.Data.Stats["Demon Fruit"].Level.Value)
            end)
        end
    end)
       
P:Toggle("Tá»± Äá»ng NÃ¢ng Chá» Sá»",_G.Stats_Kaitun,function(V)
_G.Stats_Kaitun = V
end)
...
P:Toggle("VÃµ",false,function(V)
melee = V    
end)
P:Toggle("MÃ¡u",false,function(V)
defense = V
end)
P:Toggle("Kiáº¿m",false,function(V)
sword = V
end)
P:Toggle("SÃºng",false,function(V)
gun = V
end)
P:Toggle("TrÃ¡i",false,function(V)
demonfruit = V
end)
...
-------------------------------------------------------------------------------------------------------- 
    ...
    R:Dropdown("Chá»n Con Chip",Raidslist,function(V)
        _G.SelectChip = V
    end)
    
    R:Toggle("Mua chip ÄÃ£ Chá»n",_G.SelectDungeon,function(V)
        _G.SelectDungeon = V
    end)
    ...
    R:Toggle("Mua Chip ÄÃ£ Chá»n",_G.BuyChip,function(V)
        _G.BuyChip = V
    end)
    ...
    R:Toggle("Báº¯t Äáº§u VÃ o Táº­p KÃ­ch",_G.StartRaid,function(V)
        _G.StartRaid = V
    end)
    ...
    R:Button("Báº¯t Äáº§u Táº­p KÃ­ch",function()
        if World2 then
            fireclickdetector(game:GetService("Workspace").Map.CircleIsland.RaidSummon2.Button.Main.ClickDetector)
        elseif World3 then
            fireclickdetector(game:GetService("Workspace").Map["Boat Castle"].RaidSummon2.Button.Main.ClickDetector)
        ...
        R:Button("Bay Äáº¿n Äáº£o káº¿ Tiáº¿p",function()
        pcall(function()
        ...
        R:Toggle("Tá»± Äá»ng Qua Äáº£o Káº¿ Tiáº¿p",_G.Dungeon,function(V)
        _G.Dungeon = V
...
spawn(function()
    ...
    R:Toggle("Giáº¿t QuÃ¡i Xung Quanh",nil,function(V)
    _G.Kill_Aura = V
    end) 
...
spawn(function()
    ...
    R:Toggle("Tá»± Äá»ng Thá»©c Tá»nh",_G.Awakener,function(V)
        _G.Awakener = V
    end)
    ...
    if World2 then
        R:Button("Bay Äáº¿n Chá» Táº­p KÃ­ch",function()
    ...
    if World2 then
        R:Button("Bay Äáº¿n PhÃ²ng Thá»©c TÄ©nh",function()
    ...
    R:Seperator("Kiáº¿m KoKo")
    
 R:Toggle("ÄÃ¡nh Law", _G.OderSword,function(V)
     _G.OderSword = V
    StopTween( _G.OderSword)
    end)
    
    R:Toggle("ÄÃ¡nh Law Äá»i MÃ¡y Chá»§", _G.OderSwordHop,function(V)
         _G.OderSwordHop = V
    end)
    ...
    R:Button("Báº¯t Äáº§u VÃ o Táº­p KÃ­ch Law",function()
        if World2 then
            fireclickdetector(game:GetService("Workspace").Map.CircleIsland.RaidSummon.Button.Main.ClickDetector)
        end
    end)
--------------------------------------------------------------------------------------------------------
    T:Seperator("Tháº¿ Giá»i")
    
    T:Button("Dá»ch Chuyá»n Vá» Biá»n 1",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelMain")
    end)
    
    T:Button("Dá»ch Chuyá»n Vá» Biá»n 2",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelDressrosa")
    end)
    
    T:Button("Dá»ch Chuyá»n Vá» Biá»n 3",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelZou")
    end)
    
T:Seperator("Cá»ng Dá»ch Chuyá»n")
    
    if World1 then
        T:Dropdown("Chá»n Cá»ng",{
            "Sky Island 1",
            "Sky Island 2",
            "Under Water Island",
    ...
    T:Toggle("Dá»ch Chuyá»n Äáº¿n Cá»ng ÄÃ£ Chá»n",false,function(V)
        _G.TeleFast = V
...
--------------------------------------------------------------------------------------------------------
    S:Seperator("Kháº£ NÄng")
    
    S:Button("Mua Nháº£y LiÃªn Tá»¥c [ 10,000 Beli ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Geppo")
    end)
    
    S:Button("Mua Haki VÅ© Trang [ 25,000 Beli ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Buso")
    end)
    
    S:Button("Mua Dá»ch Chuyá»n [ 25,000 Beli ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyHaki","Soru")
    end)
    
    S:Button("Mia Haki Quan SÃ¡t [ 750,000 Beli ]",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("KenTalk","Buy")
    end)
    
S:Toggle("Mua Táº¥t Cáº£", false, function(t)
    Abilities = t
    ...
    S:Seperator("Mua Báº±ng Äiá»m TÃ­m")

S:Button("KhÃ´i Phá»¥c Chá» Sá» (2.5K F)", function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Refund","1")
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Refund","2")
end)

S:Button("Äá»i Tá»c (3K F)", function()
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Reroll","1")
	game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Reroll","2")
end)

S:Button("Mua Tá»c Cyborg (2.5K F)", function()
    local args = {
		[1] = "CyborgTrainer",
		[2] = "Buy"
	}
...
--------------------------------------------------------------------------------------------------------
    ...
    _G.SelectFruit = ""
    D:Dropdown("Chá»n TrÃ¡i",Table_DevilFruitSniper,function(V)
        _G.SelectFruit = V
    end)
    
    D:Toggle("Mua TrÃ¡i ÄÃ£ Chá»n",_G.BuyFruitSniper,function(V)
        _G.BuyFruitSniper = V
    end)
    
    D:Seperator("KhÃ¡c")
    
    D:Dropdown("Chá»n TrÃ¡i Äá» Än",Table_DevilFruitSniper,function(V)
        _G.SelectFruitEat = V
    end)
    
    D:Toggle("Än TrÃ¡i ÄÃ£ Chá»n",_G.EatFruit,function(V)
        _G.EatFruit = V
    end)
    ...
    D:Button("Quay TrÃ¡i",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Cousin","Buy")
    end)
    
    D:Button("Má» Shop BÃ¡n TrÃ¡i",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GetFruits")
        game:GetService("Players").LocalPlayer.PlayerGui.Main.FruitShop.Visible = true
    end)
    
    D:Toggle("Tá»± Äá»ng LÆ°u TrÃ¡i",_G.StoreFruit,function(V)
        _G.StoreFruit = V
    end)
...
spawn(function()
    ...
    D:Toggle("Dá»ch Chuyá»n Äáº¿n Nháº·t TrÃ¡i",_G.Grabfruit,function(V)
    _G.Grabfruit = V
    end)
    spawn(function()
			while wait(.1) do
    ...
    D:Toggle("Bay Äáº¿n Nháº·t TrÃ¡i",_G.Tweenfruit,function(V)
    _G.Tweenfruit = V
...
--------------------------------------------------------------------------------------------------------
    Mc:Seperator("MÃ¡y Chá»§")
    
    Mc:Button("VÃ o Láº¡i MÃ¡y Chá»§",function()
        game:GetService("TeleportService"):Teleport(game.PlaceId, game:GetService("Players").LocalPlayer)
    end)
    
    Mc:Button("Äá»i MÃ¡y Chá»§",function()
        Hop()
    end)
    
    Mc:Button("Äá»i MÃ¡y Chá»§ Ãt NgÆ°á»i",function()
    ...
    Mc:Button("Sao ChÃ©p Id MÃ¡y Chá»",function()
	setclipboard(tostring(game.JobId))
	end)
	
    Mc:Textbox("Nháº­p Id MÃ¡y Chá»§", true, function(V)
	_G.Job = V
	end)

	Mc:Button("VÃ o MÃ¡y Chá»§ ÄÃ£ Nháº­p id",function()
	game:GetService("TeleportService"):TeleportToPlaceInstance(game.placeId,_G.Job, game.Players.LocalPlayer)
	end)
	
    Mc:Seperator("KhÃ¡c")
    
    Mc:Button("TÃªn TiÃªu Äá»",function()
    local args = {
        [1] = "getTitles"
    }
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
...
Mc:Button("Má» Báº£n Haki MÃ u",function()
    game.Players.localPlayer.PlayerGui.Main.Colors.Visible = true
end)
      
Mc:Seperator("Phe")
    
    Mc:Button("VÃ o Phe Háº£i Táº·c",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetTeam","Pirates") 
    end)
    
    Mc:Button("VÃ o Phe Háº£i QuÃ¢n",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("SetTeam","Marines") 
    end)
    
Mc:Seperator(" KhÃ¡c ")

Mc:Toggle("Chá»ng AFK", true, function()
...
repeat wait() until game:IsLoaded() 
    ...
    Mc:Button("Nháº­p Táº¥t Cáº£ Code",function()
    ...
    Mc:Dropdown("Chá»n Code KhÃ´i Phá»¥c Chá» Sá»",{"NOOB_REFUND","SUB2GAMERROBOT_RESET1","Sub2UncleKizaru"},function(V)
        _G.CodeSelect = V
    end)
    
    Mc:Button("Nháº­p Code ÄÃ£ Chá»n",function()
        game:GetService("ReplicatedStorage").Remotes.Redeem:InvokeServer(_G.CodeSelect)
    end)
    
    Mc:Seperator("TÃ¬nh tráº¡ng")
    
    Mc:Dropdown("Chá»n TÃ¬nh Tráº¡ng Haki",{"TÃ¬nh Tráº¡ng 0","TÃ¬nh Tráº¡ng 1","TÃ¬nh Tráº¡ng 2","TÃ¬nh Tráº¡ng 3","TÃ¬nh Tráº¡ng 4","TÃ¬nh Tráº¡ng 5"},function(V)
        _G.SelectStateHaki = V
    end)
    
    Mc:Button("Change Buso Haki State",function()
        if _G.SelectStateHaki == "TÃ¬nh Tráº¡ng 0" then
            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ChangeBusoStage",0)
        elseif _G.SelectStateHaki == "TÃ¬nh Tráº¡ng 1" then
            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ChangeBusoStage",1)
        elseif _G.SelectStateHaki == "TÃ¬nh Tráº¡ng 2" then
            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ChangeBusoStage",2)
        elseif _G.SelectStateHaki == "TÃ¬nh Tráº¡ng 3" then
            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ChangeBusoStage",3)
        elseif _G.SelectStateHaki == "TÃ¬nh Tráº¡ng 4" then
            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ChangeBusoStage",4)
        elseif _G.SelectStateHaki == "TÃ¬nh Tráº¡ng 5" then
