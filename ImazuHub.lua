 game:IsLoaded() then game.Loaded:Wait() end
local fask = task
...
Page.Image = "http://www.roblox.com/asset/?id=117142420259738" .. tostring(0)
...
ttittles.Text = "Imazu Hub | by Teddy"
...
local Logo = Instance.new("ImageLabel")
	...
	Logo.Image = "rbxassetid://117142420259738"]]--
...
L2.Image = "rbxassetid://117142420259738"
L2.Draggable = true
...
local V4 = A:T("Tộc - Mirage","rbxassetid://10747372167")
local E = A:T("Sea Events","rbxassetid://10709761530")
...
local Mc = A:T("Misc","rbxassetid://10709782582")
--------------------------------------------------------------------------------------------------------
I:Seperator("Discord")

I:Label("Tham Gia Discord Để Nhận Thông Báo Mới Nhất Nhé")
...
UpdateClient1()
    ...
    spawn(function()
        while wait() do
            pcall(function()
                localfrag:Set("Feagment:".." "..game:GetService("Players").LocalPlayer.Data.Fragments.Value)
            end)
        end
    end)
    ...
    spawn(function()
        while wait() do
            pcall(function()
                localbountyhornor:Set("Bounty:".." "..game:GetService("Players").LocalPlayer.leaderstats["Bounty/Honor"].Value)
            end)
        end
    end)
    
    local localDevil = I:Label("Fruit")
...
local WeaponList = {"Melee","Sword","Fruits","Gun"}
_G.SelectWeapon = "VÃµ"
...
local AttackList = {"Chọn", "Normal", "Fast", "Super Fast"}
FireCooldown = "Super Fast"
...
spawn(function()
    while wait() do
        if FireCooldown then
            pcall(function()
                if FireCooldown == "Chọn" then
                    FireCooldown = 0.1
                elseif FireCooldown == "Normal" then
                    FireCooldown = 0.07
                elseif FireCooldown == "Fast" then
                    FireCooldown = 0.04
                elseif FireCooldown == "Super Fast" then
                    FireCooldown = 0.02
                end
            end)
        end
...
game:GetService("StarterGui"):SetCore("SendNotification", {
    Title = "Imazu Hub";
    Text = "Script Loaded !!";
    Icon = "rbxthumb://type=Asset&id=117142420259738&w=150&h=150";
    Duration = 10
})
