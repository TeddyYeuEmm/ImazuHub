...
OrionLib:MakeNotification({
	Name = "Imazu Hub ",
	Content = "Chọn Team Đi Thằng Ngu",
...
local locallv = W:AddLabel("Level")
    ...
    W:AddLabel("[+] VN: Beta Đéo Đòi Hỏi Nhiều Nhé")
    -- W:AddLabel("Skidder Muon Nam")
    ...
    local LevelFarmFarm W:AddLabel("Kaitun : Có Con Cặc")
    W:AddLabel("Config Save : Update Sau...")
